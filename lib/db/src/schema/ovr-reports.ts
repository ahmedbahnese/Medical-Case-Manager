...
export const ovrReportsTable = sqliteTable("ovr_reports", {
  ...
  hospitalSupervision: text("hospital_supervision").notNull().default("إشراف المستشفى"),
  administrativeManager: text("administrative_manager").notNull().default("المدير الإداري"),
