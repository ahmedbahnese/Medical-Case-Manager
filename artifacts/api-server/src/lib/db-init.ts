...
export async function initDatabase(): Promise<void> {
  try {
    const ddl = [
      ...
      `CREATE TABLE IF NOT EXISTS notifications (id INTEGER PRIMARY KEY AUTOINCREMENT, message TEXT NOT NULL, from_user TEXT NOT NULL, audience TEXT NOT NULL DEFAULT 'selected', recipients_json TEXT NOT NULL DEFAULT '[]', read_by_json TEXT NOT NULL DEFAULT '[]', created_at INTEGER NOT NULL DEFAULT (strftime('%s','now')*1000))`,
    ];
