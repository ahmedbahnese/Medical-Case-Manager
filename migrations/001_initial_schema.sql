...
CREATE INDEX IF NOT EXISTS idx_medical_cases_dept     ON medical_cases(department_id);
CREATE INDEX IF NOT EXISTS idx_medical_cases_status   ON medical_cases(status);
CREATE INDEX IF NOT EXISTS idx_medical_cases_admitted ON medical_cases(admission_date DESC);
CREATE INDEX IF NOT EXISTS idx_medical_cases_resp     ON medical_cases(artificial_respiration);
CREATE INDEX IF NOT EXISTS idx_waiting_cases_status   ON waiting_cases(status);
CREATE INDEX IF NOT EXISTS idx_waiting_cases_section  ON waiting_cases(section);
